...
public class InformacionVehiculos {
	...
	public void launchbrowser() {
		...
		WebDriver driver = new ChromeDriver();
				...
				driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[2]/div/div[3]/div/a/div/div[1]/div")).click(); //Da click en la imagen del vehiculo para mostrar la informacion
			
	}

	public static void main(String[] args) {
		
		InformacionVehiculos Informacion = new InformacionVehiculos();
		Informacion.launchbrowser();
